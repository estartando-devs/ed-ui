...
var ReactLoading = /*@__PURE__*/getDefaultExportFromCjs(reactLoading.exports);
...
const VARIANT = {
    ...
    &:hover {
      background-color: ${(props) => curriedShade(0.15, props.theme.palette.primary.main)};
      border-color: ${(props) => curriedShade(0.15, props.theme.palette.primary.main)};
    }
    &:active {
      background-color: ${(props) => props.theme.palette.primary.main};
      border-color: ${(props) => props.theme.palette.primary.main};
  ...
  `,
    ...
    &:hover {
      border-color: ${(props) => curriedShade(0.15, props.theme.palette.primary.main)};
      color: ${(props) => curriedShade(0.15, props.theme.palette.primary.main)};
    }
    &:active {
      border-color: ${(props) => props.theme.palette.primary.main};
      color: ${(props) => props.theme.palette.primary.main};
  ...
  `,
    ...
    &:hover {
      border-color: ${(props) => curriedShade(0.15, props.theme.palette?.design?.main || '#FFF')};
      color: ${(props) => curriedShade(0.15, props.theme.palette?.design?.contrastText || '#FFF')};
    }
    &:active {
...
const Button = ({ isLoading, children, ...rest }) => (jsxRuntime.jsx(ButtonContainer, Object.assign({ isLoading: isLoading }, rest, { children: isLoading ? (jsxRuntime.jsx(ReactLoading, { type: "spokes", height: "20px", width: "20px" }, void 0)) : (children) }), void 0));
Button.defaultProps = {
    variant: 'default',
    size: 'small',
    isLoading: false,
...
exports.EDUIProvider = EDUIProvider;
